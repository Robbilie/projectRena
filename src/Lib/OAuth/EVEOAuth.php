...
class EVEOAuth
{
				...
				public function LoginURL()
				{
								...
								return "https://login.eveonline.com/oauth/authorize?response_type=code&redirect_uri=" . "https://core.eneticum.rep.pm" . $this->config->getConfig("callBack", "crestsso", "/login/eve/") . "&client_id=" . $this->config->getConfig("clientID", "crestsso") . "&scope=" . "&state=" . $requestURI;
				}
