<?php
    ...
    $groupTypes = [
        $groupSkillTraining => [$notificationTypeSkillEmptyQueue, $notificationTypeSkillFinished, $notificationTypeUnusedSkillPoints],
        $groupAgents => [
    ...
    $nonCommunicationTypes = array_merge([
        $notificationTypeContactSignedOn,
        $notificationTypeContactSignedOff,
        $notificationTypeMailSummary,
        $notificationTypeNewMailFrom,
        ...
        $notificationTypeNewRedeemableItem
    ], $groupTypes[$groupSkillTraining]);

    $groupNamePaths = [
        $groupAgents => 'Notifications/groupAgents',
    ...
    $groupNamePathsNewNotifications = [
        $groupAgents => 'Notifications/groupAgents',
        $groupBills => 'Notifications/groupBills',
        $groupContacts => 'Notifications/groupContacts',
        $groupCorp => 'Notifications/groupCorporation',
    ...
    $notificationDisplaySender = array_merge($groupTypes[$groupAgents], $groupTypes[$groupCorp], $groupTypes[$groupContacts], [
        $notificationTypeCorpOfficeExpirationMsg,
        $notificationTypeSovereigntyTCUDamageMsg,
        $notificationTypeSovereigntySBUDamageMsg,
        $notificationTypeSovereigntyIHDamageMsg,
    ...
    function GetTypeGroup ($typeID) {
    	foreach ($groupTypes as $groupID => $typeIDs)
    		if(in_array($typeID, $typeIDs))
    			return $groupID;
    }

    function IsTypeInCommunications ($typeID) {
    	if(in_array($typeID, $nonCommunicationTypes))
    		return false;
    	else
    		return true;
    }
